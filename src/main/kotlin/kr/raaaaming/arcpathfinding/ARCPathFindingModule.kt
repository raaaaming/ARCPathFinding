package kr.raaaaming.arcpathfinding
...
import kr.raaaaming.arcpathfinding.cch.contractUltra
import kr.raaaaming.arcpathfinding.cch.customizeWeightsPerfectFast
...
import kr.raaaaming.arcpathfinding.config.WorldProgress
import kr.raaaaming.arcpathfinding.core.QueryEngineFastSnap
import kr.raaaaming.arcpathfinding.graph.mergeChunks
import kr.raaaaming.arcpathfinding.navigation.NavigationManager
import kr.raaaaming.arcpathfinding.path.PathService
import kr.raaaaming.arcpathfinding.path.PathServiceImpl
import kr.raaaaming.arcpathfinding.policy.MovePolicy
import kr.raaaaming.arcpathfinding.policy.WeightPolicy
import kr.raaaaming.arcpathfinding.policy.makeAttrWeightFn
import kr.raaaaming.arcpathfinding.policy.node.buildNodeAttrs
import kr.raaaaming.arcpathfinding.preprocess.PreprocessService
import kr.raaaaming.arcpathfinding.query.getBlockQuery
import kr.raaaaming.arcpathfinding.separator.buildOrderByChunkSeparatorFast
import kr.raaaaming.arcpathfinding.wnm.WNMHeader
import kr.raaaaming.arcpathfinding.wnm.WNMStore
...
@ModuleSpec(
    ...
    authors = ["raaaaming"],
    providesServices = ["kr.raaaaming.arcpathfinding.path.PathService"]
)
